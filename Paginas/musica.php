...
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image" href="../Imagens/logotipo/menu.png"/>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-black">
            <div class="container">
                <div class="col justify-content-center">
                    <img src="../Imagens/logotipo/menu.png" class="img-fluid rounded-start" alt="..." style="max-width: 240px;">
                </div> 
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item text-primary disabled" href="musica.php">Música </a></li>
                            ...
                            <div class="boxcard">
                                <div class="box">
                                    <div class="text-center text-white">
                                        <a class="btn btn-outline-primary" href="Musica/D-Cry-novaera(freestyle).php" >
                                            <img class="img-fluid" src="../Imagens/capas/7.jpg" alt="..." />
                                            <br><br>
                                            <p class="lead fw-bolder mb-2 text-black-50 mb-0"></p>
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="box">
                                    <div class="text-center text-white">
                                        <a class="btn btn-outline-primary" href="Musica/D-Cry-Resiliencia(Mixtape).php" >
                                            <img class="img-fluid" src="../Imagens/capas/6.png" alt="..." />
                                            <br><br>
                                            <p class="lead fw-bolder mb-2 text-black-50 mb-0"></p>
                                        </a>
                                    </div>
                        ...
                        <div class="div"  data-aos="fade-up"> 
                            <div class="boxcard">
                                <div class="box">
                                    <div class="text-center text-white">
                                        <a class="btn btn-outline-primary" href="Musica/D-Cry-Resiliencia(Mixtape).php" >
                                            <img class="img-fluid" src="../Imagens/capas/5.jpg" alt="..." />
                                            <br><br>
                                            <p class="lead fw-bolder mb-2 text-black-50 mb-0"></p>
                                        </a>
                                    </div>
                        ...
                        <div class="div"  data-aos="fade-up"> 
                            <div class="boxcard">
                                <div class="box">
                                    <div class="text-center text-white">
                                        <a class="btn btn-outline-primary" href="Musica/D-Cry-Resiliencia(Mixtape).php" >
                                            <img class="img-fluid" src="../Imagens/capas/4.jpg" alt="..." />
                                            <br><br>
                                            <p class="lead fw-bolder mb-2 text-black-50 mb-0"></p>
                                        </a>
                                    </div>
                        ...
                        <div class="div"  data-aos="fade-up"> 
                            <div class="boxcard">
                                <div class="box">
                                    <div class="text-center text-white">
                                        <a class="btn btn-outline-primary" href="Musica/D-Cry-Resiliencia(Mixtape).php" >
                                            <img class="img-fluid" src="../Imagens/capas/3.jpg" alt="..." />
                                            <br><br>
                                            <p class="lead fw-bolder mb-2 text-black-50 mb-0"></p>
                                        </a>
                                    </div>
                        ...
                        <div class="div"  data-aos="fade-up"> 
                            <div class="boxcard">
                                <div class="box">
                                    <div class="text-center text-white">
                                        <a class="btn btn-outline-primary" href="Musica/D-Cry-Resiliencia(Mixtape).php" >
                                            <img class="img-fluid" src="../Imagens/capas/2.jpg" alt="..." />
                                            <br><br>
                                            <p class="lead fw-bolder mb-2 text-black-50 mb-0"></p>
                                        </a>
                                    </div>
                        ...
                        <div class="div"  data-aos="fade-up"> 
                            <div class="boxcard">
                                <div class="box">
                                    <div class="text-center text-white">
                                        <a class="btn btn-outline-primary" href="Musica/D-Cry-Resiliencia(Mixtape).php" >
                                            <img class="img-fluid" src="../Imagens/capas/1.jpg" alt="..." />
                                            <br><br>
                                            <p class="lead fw-bolder mb-2 text-black-50 mb-0"></p>
                                        </a>
                                    </div>
        ...
        <script src="../Controlos/js/script.js"></script>
