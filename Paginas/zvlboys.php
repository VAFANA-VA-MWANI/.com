                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item text-primary disabled" href="zvlboys.php">Zvlboys</a></li>
        ...
        <header class="bg-dark py-5" style="
            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">ZVL BOYS 2023</h1>
            ...
            <div class="container">
                ...
                <div class="row text-black">
                    <div class="col-lg-3 ms-auto">
                        <div class="div" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                            <div class="testimonial-item text-center">
                                <div class="flex-shrink-0">
                                    <img src="../Imagens/zvlboys/D-Cry.jpg"
                                    alt="Generic placeholder image" class="img-fluid rounded-circle border border-success border-3"
                                    style="width: 1200px;">
                                </div>
                                <h3>D-Cry</h3>
                                <p>Ceo &amp; Founder</p>
                    ...
                    <div class="col-lg-3 ms-auto">
                        <div class="div" data-aos="flip-up">
                            <div class="testimonial-item text-black text-center">
                                <div class="flex-shrink-0">
                                    <img src="../Imagens/zvlboys/Big zenny.jpg"
                                    alt="Generic placeholder image" class="img-fluid rounded-circle border border-success border-3"
                                    style="width: 1200px;">
                                </div>
                                <h3>Big Zenny</h3>
                    ...
                    <div class="col-lg-3 ms-auto">
                        <div class="div"  data-aos="fade-up">
                            <div class="testimonial-item text-center">
                                <div class="flex-shrink-0">
                                    <img src="../Imagens/zvlboys/Del-c.jpg"
                                    alt="Generic placeholder image" class="img-fluid rounded-circle border border-success border-3"
                                    style="width: 1200px;">
                                </div>
                                <h3>Del-c</h3>
                    ...
                    <div class="col-lg-3 ms-auto">
                        <div class="div" data-aos="zoom-in">
                            <div class="testimonial-item text-center">
                                <div class="flex-shrink-0">
                                    <img src="../Imagens/zvlboys/Inen boss.jpg"
                                    alt="Generic placeholder image" class="img-fluid rounded-circle border border-success border-3"
                                    style="width: 1200px;">
                                </div>
                                <h3>Inen boss</h3>
                ...
                <div class="row text-black">
                    <div class="col-lg-3 ms-auto">
                        <div class="div" data-aos="fade-right" data-aos-duration="1000" data-aos-once="true">
                            <div class="testimonial-item text-center">
                                <div class="flex-shrink-0">
                                    <img src="../Imagens/zvlboys/V-jay.jpg"
                                    alt="Generic placeholder image" class="img-fluid rounded-circle border border-success border-3"
                                    style="width: 1200px;">
                                </div>
                                <h3>V-jay</h3>
                    ...
                    <div class="col-lg-3 ms-auto">
                        <div class="div" data-aos="flip-up">
                            <div class="testimonial-item text-black text-center">
                                <div class="flex-shrink-0">
                                    <img src="../Imagens/zvlboys/Big zenny1.jpg"
                                    alt="Generic placeholder image" class="img-fluid rounded-circle border border-success border-3"
                                    style="width: 1200px;">
                                </div>
                                <h3>Big Zenny</h3>
                    ...
                    <div class="col-lg-3 ms-auto">
                        <div class="div"  data-aos="fade-up">
                            <div class="testimonial-item text-center">
                                <div class="flex-shrink-0">
                                    <img src="../Imagens/zvlboys/Del-c1.jpg"
                                    alt="Generic placeholder image" class="img-fluid rounded-circle border border-success border-3"
                                    style="width: 1200px;">
                                </div>
                                <h3>Del-c</h3>
                    ...
                    <div class="col-lg-3 ms-auto">
                        <div class="div" data-aos="zoom-in">
                            <div class="testimonial-item text-center">
                                <div class="flex-shrink-0">
                                    <img src="../Imagens/zvlboys/Inen boss1.jpg"
                                    alt="Generic placeholder image" class="img-fluid rounded-circle border border-success border-3"
                                    style="width: 1200px;">
                                </div>
                                <h3>Inen boss</h3>
