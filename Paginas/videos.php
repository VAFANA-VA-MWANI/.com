                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item text-primary disabled" href="videos.php">Vídeos</a></li> 
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">VVM Vídeos 2023</h1>
                    <p class="lead fw-normal text-white-50 mb-0">O Universo da nossa cultura.</p>
                </div>
            </div>
        </header>
        <!-- Videos-->
        <section class="page-section bg-primary" id="Vídeos">
                ...
                <div class="row gx-0 mb-5 mb-lg-0 justify-content-center">
                        ...
                        <div class="card bg-dark">
                            <div class="card-body">
                                <div class="ratio ratio-16x9">
                                    <iframe src="https://www.youtube.com/embed/hzBG-YcSqZo" title="YouTube video" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="card bg-dark">
                            <div class="card-body">
                                <div class="ratio ratio-16x9">
                                    <iframe src="https://www.youtube.com/embed/YV8rEf46GZI" title="YouTube video" allowfullscreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
